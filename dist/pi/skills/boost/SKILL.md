...
|---|---|---|
| boost-coder-coordinator | Coding | `subagent` tool, agent `boost-coder-coordinator` |
| boost-investigator-coordinator | Investigation & Plan/Review | `subagent` tool, agent `boost-investigator-coordinator` |
...
2. Spawn the appropriate coordinator agent with the `subagent` tool, working directory inherited
